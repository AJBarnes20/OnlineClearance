    ...
    public class StudentController : Controller
    {
        ...
        public IActionResult Dashboard()
        {
            ...
            var model = new StudentDashboardViewModel
            {
                ...
                TotalSubjects     = 0,
                TotalOrgs         = 0,
                ActivePeriod      = "A.Y. 2025-2026, First Semester",
            ...
            try
            {
                ...
                var subjCmd = new MySqlCommand(@"
                    SELECT
                        ...
                        SUM(CASE WHEN cs.status != 2 THEN 1 ELSE 0 END) AS incomplete
                ...
                while (ar.Read())
                {
                    model.Announcements.Add(new AnnouncementItem
                    {
                        ...
                        Date    = ar.GetDateTime("created_at")
                                    .ToString("MMMM d, yyyy")
                    });
                }
            }
            catch { /* show safe defaults */ }
        ...
        public IActionResult ConfirmSubjects(string selectedSubjects)
        {
            ...
            try
            {
                ...
                // Delete old selections for this period
                ...
                // Insert new selections — status 1 = Pending
        ...
        public IActionResult Organization()
        {
            ...
            try
            {
                ...
                // Get student's curriculum_id and student_number
...
public IActionResult Profile()
{
    ...
    try
    {
        ...
        // Step 1: Get user info + student info in one query
        var cmd = new MySqlCommand(@"
            SELECT
                u.id, u.first_name, u.middle_initial,
        ...
        if (r.Read())
        {
            // Student ID: prefer student_number, fallback to id_number
        ...
        public IActionResult DownloadPdf()
        {
            ...
            try
            {
                ...
                model.AySemester = !string.IsNullOrEmpty(periodLabel)
                                    ? periodLabel : "2025-2026 / First Semester";
        ...
        private void SetUserViewData()
{
    ...
    try
    {
        ...
        // Get student info + fallback id_number
        var cmd = new MySqlCommand(@"
            SELECT
                s.student_number,
                u.id_number,
        ...
        if (r.Read())
        {
            // Prefer student_number, fallback to id_number
            var studentNum = r.IsDBNull(r.GetOrdinal("student_number"))
                                ? null : r.GetString("student_number");
            var idNumber   = r.IsDBNull(r.GetOrdinal("id_number"))
                                ? null : r.GetString("id_number");
